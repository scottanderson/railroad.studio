...
export const legacyIndustryTypes = {
    'CattleFarm': IndustryType.wood_rick, // FIXME, cattle farm
    ...
    'enginehouse_aspen': IndustryType.engine_house_gold,
    ...
    'MeatPackingPlant': IndustryType.wood_rick, // FIXME, meat packing plant
...
export const industryNames: Record<IndustryName, string> = {
    ...
    'enginehouse_aspen': 'Engine House (Aspen)',
    ...
    'enginehouse_princes_mineral_brown': 'Engine House (Princess Mineral Brown)',
...
export const industryNameProductInputLabels: Record<IndustryName, FourStrings> = {
    ...
    'logcamp': input1234,
    'MeatPackingPlant': input1234, // FIXME
...
export const industryNameProductOutputLabels: Record<IndustryName, FourStrings> = {
    ...
    'MeatPackingPlant': output1234, // FIXME
