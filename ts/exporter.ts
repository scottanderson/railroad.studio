...
export function railroadToGvas(railroad: Railroad): Gvas {
    ...
    for (const propertyName of railroad._order) {
        switch (propertyName.toLowerCase()) {
            ...
            case 'splinetrackendspline1idarray': intArrays[propertyName] = railroad.splineTracks.map((st) => st.endSpline1Id); break;
            case 'splinetrackendspline2idarray': intArrays[propertyName] = railroad.splineTracks.map((st) => st.endSpline2Id); break;
            ...
            case 'splinetrackstartsplineidarray': intArrays[propertyName] = railroad.splineTracks.map((st) => st.startSplineId); break;
